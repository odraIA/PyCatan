...
BENCHMARK_AGENTS = [aha, paaa, ha]
n_matches_per_permutation = 1
porcentaje_workers = 0.95

# Agentes a evaluar: (ruta_clase, params)
agentes_a_evaluar = [
    ("Agents.HeurOllamaAgent.HeurOllamaAgent", {"model": "qwen3.5:2b", "prompt_size": "MEDIUM"}),
    ("Agents.HeurOllamaAgent.HeurOllamaAgent", {"model": "qwen3.5:2b", "prompt_size": "SMALL"}),
    ("Agents.HeurOllamaAgent.HeurOllamaAgent", {"model": "smollm3", "prompt_size": "MEDIUM"}),
    ("Agents.HeurOllamaAgent.HeurOllamaAgent", {"model": "smollm3", "prompt_size": "SMALL"}),
    ("Agents.HeurOllamaAgent.HeurOllamaAgent", {"model": "qwen3.5:0.8b", "prompt_size": "MEDIUM"}),
    ("Agents.HeurOllamaAgent.HeurOllamaAgent", {"model": "qwen3.5:0.8b", "prompt_size": "SMALL"}),
