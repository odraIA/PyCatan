...
class HeuristicAgent(AgentInterface):
    """
    Agente heurístico orientado a juego competitivo:
    - Prioriza ciudades (ore+wheat) y cartas de desarrollo en planes viables.
    - Busca expansión eficiente hacia nodos de alto valor/puertos.
    - Usa el ladrón para frenar al rival más fuerte en recursos clave.
    """
