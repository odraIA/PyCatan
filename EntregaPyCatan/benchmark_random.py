...
agentes_a_evaluar = [
    ("Agents.HeuristicAgent.HeuristicAgent", None), # Por ejemplo, si quieres evaluar el agente AdrianHerasAgent, que está en Agents.AdrianHerasAgent sin parámetros adicionales
